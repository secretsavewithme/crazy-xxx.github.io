...
var Duties, Game, Kinks, OWRMain, Roll, StartSelector, Twists, Xmoney, Ymoney, button, calcMoney, d, d19, div, form, h1, h3, input, label, li, option, p, ref, rollCounter, select, span, strong, ul,
  slice = [].slice;
...
ref = React.DOM, button = ref.button, div = ref.div, form = ref.form, h1 = ref.h1, h3 = ref.h3, input = ref.input, label = ref.label, li = ref.li, option = ref.option, p = ref.p, select = ref.select, span = ref.span, strong = ref.strong, ul = ref.ul;
