...
var Game, TH1Main, button, d16, div, form, fullRow, h1, h3, h4, img, input, label, li, option, p, ref, row, select, span, strong, ul;
...
TH1Main = React.createClass({displayName: "TH1Main",
  ...
  render: function() {
    return div({
      className: "container"
    }, h1({}, 'TH1Main'), this.state.started ? React.createElement(Game, {
