...
var Fuck, Game, Panel, Spit, TH1Main, TimerButton, a, button, div, el, form, fullRow, h1, h2, h3, h4, img, input, label, li, option, p, ref, row, select, span, strong, ul;
...
Game = React.createClass({displayName: "Game",
  ...
  headingFor: function(n) {
    return "Task " + n + " — " + this.Headings[this.props.mode - 1][n - 1];
  },
