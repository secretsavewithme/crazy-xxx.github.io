...
var DTTMain, Game, MinMaxSelector, NumberSelector, StartSelector, Tasks, a, br, button, calculateTargetTime, div, dup, el, form, game, gameInitialState, gameParamValid, gameParams, gameParamsDefaults, gameParamsInitialState, generateTask, h1, h2, h3, h4, img, input, isGtZero, label, li, local, make, option, p, parseQueryParams, ref, render, saveDup, select, small, span, speak, store, strong, tellTask, timer, trainerLogic, ul, wait,
  slice = [].slice;
