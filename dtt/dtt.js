...
var DTTMain, Game, MinMaxSelector, NumberSelector, StartSelector, a, button, calculateTargetTime, div, el, form, game, gameInitialState, gameParamValid, gameParams, gameParamsInitialState, h1, h2, h3, h4, img, input, label, li, make, newState, option, p, ref, render, select, span, store, strong, trainerLogic, ul,
  slice = [].slice;
...
Game = React.createClass({
  render: function() {
    return div({}, "Target: " + this.props.target);
  }
});
