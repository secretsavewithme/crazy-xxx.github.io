...
var DTTMain, Game, MinMaxSelector, NumberSelector, StartSelector, Tasks, a, button, calculateTargetTime, div, dup, el, form, game, gameInitialState, gameParamValid, gameParams, gameParamsInitialState, generateTask, h1, h2, h3, h4, img, input, isGtZero, isSpeechEnabled, label, li, local, make, option, p, ref, render, select, small, span, speak, store, strong, timer, trainerLogic, ul, wait,
  slice = [].slice;
